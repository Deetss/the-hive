...
test('the reported paste: Claude Code blockquote rail is dropped', () => {
  assert.equal(
    sanitizeTerminalSelection('▎ The Hive — clones for you and your team, working 24/7.'),
    'The Hive — clones for you and your team, working 24/7.'
  );
});

test('every line of a multi-line quote loses its rail', () => {
  const copied = [
    '▎ The Hive is live on Product Hunt today.',
    '▎',

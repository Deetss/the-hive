...
function ExchangeCard({
  ...
  const tail = (() => {
    ...
    return 'No reply yet. Abathur has this one.';
  })();
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <PixelButton
              ...
              title="Send this message through to Abathur"
            >
...
const SECTIONS: { key: Source; label: string; blurb: string }[] = [
  {
    key: 'webhook',
    label: 'Webhooks',
    blurb: 'Everything posted to your webhook endpoints, next to what Abathur sent back.'
  },
  {
    key: 'org',
    label: 'Organization',
    blurb: 'Messages from your teammates’ clone nodes, next to what Abathur sent back.'
  }
];
        ...
        {exchanges.length === 0 ? (
          source === 'org' ? (
            ...
            <EmptyState
              ...
              body={'When something posts to one of your endpoints, it lands here with Abathur’s '

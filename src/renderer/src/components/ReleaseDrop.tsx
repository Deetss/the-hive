 ...
 * three square dots. It is the `.win` window from the-hive.dev, so the moment
...
export function ReleaseDrop({ version, html, onDismiss }: ReleaseDropProps) {
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-label={`What's new in The Hive ${version}`}
      ...
      >
        ...
        <div style={{
          ...
          <span style={{
            ...
            The Hive <span style={{ color: YELLOW }}>v{version.replace(/^v/, '')}</span>

/**
 * Realtime Abathur — voice session cost HUD (card rt-9, cost-guard).
 *
 ...
 * near the voice toggle (Abathur's card / fullscreen header) — it renders its own
 ...
 *    so the user (and Abathur, who can read get_cost) knows to wrap up. The actual

/**
 * Realtime Abathur — voice ACTION tools (card rt-5, Phase 2).
 *
 * The write-side function-tools that turn voice-Abathur into an orchestrator: ping
 ...
 * rule, the hard allowlist (kill-god / mass-ops forbidden), and the abathur-voice

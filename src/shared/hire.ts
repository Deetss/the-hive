 ...
 * `thehive://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export const HIRE_SPEC_V1 = 'the-hive/hire@1';
...
export interface HireManifest {
  /** Spec tag; exactly `the-hive/hire@1` for this version. */
...
/** Parse a `thehive://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'thehive:') return null;
  // Both thehive://hire?src= (host) and thehive:hire?src= (path).

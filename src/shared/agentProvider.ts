...
export const AGENT_PROVIDER_PRESETS: AgentProviderPreset[] = [
  {
    ...
    // Longest-context Claude variant — matches the "give Abathur a bigger model"
  ...
  },
  {
    ...
    // matching The Hive's autonomous Claude/Codex default.
    autoModeFlag: '--auto',
    autoFlag: '--auto',
    supportsModel: true,
    modelFlag: '--model',
    ...
    // lifecycle hooks, but The Hive does not yet install a Kimi hook bridge,
  ...
  },
  {
    ...
    // NOT use `-p` so Abathur and workers remain god-eligible / inbox-capable.

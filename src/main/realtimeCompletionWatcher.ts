/**
 * Realtime Abathur — completion watcher (card rt-12, Phase 2, "respond when done").
 *
 * When voice-Abathur DISPATCHES work (fire-and-notify, the default pattern), he does
 ...
 * make Abathur speak it unprompted ("Oscar finished — want details?").
 *
 ...
 * field here reaches Abathur. `summary` is the human-speakable line; `completedAt` is
 ...
 * whitespace, and cap length so a malicious objective can't steer what Abathur says or does.

    ...
    const req = httpsRequest(
      {
        ...
        method: 'GET',
        headers: { 'User-Agent': 'the-hive-updater', Accept: 'application/vnd.github+json' },
        timeout: 10_000
      },
      (res) => {
        let body = '';
...
const SIMULATED_NOTES = `# The Hive v9.9.9

**A local hive of Claude Code, Antigravity, Codex, Grok & Copilot agents that run themselves** —
messaging, routing, and remembering, coordinated by your clone, Abathur, who you talk to.
